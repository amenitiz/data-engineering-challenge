...
class OpenTripCrawler:
    ...
    def run(self):
        ...
        accomodations_df = self.filter_by_col_keywords(accomodations_df, "kinds",\
                                                        "skyscrapers")
    ...
    def create_spark_sessions(self):
        ...
        self.spark_session = SparkSession.builder.appName("OpenTrip Map API Crawler")\
            .getOrCreate()
    ...
    def get_accomodations_by_bbox(self):
        ...
        df = self.spark_session.createDataFrame(data=objects[0:2500], \
                                                schema = bbox_struct)
    ...
    def merge_dfs(self, df1, df2, column):
        ...
        return df1.join(df2, df1[column] ==  df2[column], "left").drop(df2[column]).dropDuplicates()
